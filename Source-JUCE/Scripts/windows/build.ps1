...
& "$JUCE_HOME\Projucer.exe" --help

& "$JUCE_HOME\Projucer.exe" --set-global-search-path windows defaultJuceModulePath "D:\a\ElectroMap\ElectroMap\Source-JUCE\JUCE\modules"
